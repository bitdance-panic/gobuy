...
type Client interface {
	...
	ListUserOrder(ctx context.Context, req *order.ListUserOrderReq, callOptions ...callopt.Option) (r *order.ListUserOrderResp, err error)
	AdminListOrder(ctx context.Context, req *order.ListUserOrderReq, callOptions ...callopt.Option) (r *order.ListUserOrderResp, err error)
}
...
func (p *kOrderServiceClient) ListUserOrder(ctx context.Context, req *order.ListUserOrderReq, callOptions ...callopt.Option) (r *order.ListUserOrderResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ListUserOrder(ctx, req)
}

func (p *kOrderServiceClient) AdminListOrder(ctx context.Context, req *order.ListUserOrderReq, callOptions ...callopt.Option) (r *order.ListUserOrderResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
