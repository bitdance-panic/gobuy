...
func (p *kClient) ListUserOrder(ctx context.Context, req *order.ListUserOrderReq) (r *order.ListUserOrderResp, err error) {
...
func (p *kClient) AdminListOrder(ctx context.Context, req *order.ListUserOrderReq) (r *order.ListUserOrderResp, err error) {
